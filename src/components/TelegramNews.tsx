        ...
        {posts.map((post) => (
          ...
          >
            {post.image ? (
              ...
              <div className="relative h-48 bg-gradient-to-br from-[#1e3a5f] via-[#2a5080] to-[#1a3055] flex items-end p-5">
                <div className="absolute top-3 left-3">
                ...
                <p className="text-white font-semibold text-sm leading-snug line-clamp-3 relative z-10">
                  {post.text}
                </p>
              </div>
            )}
