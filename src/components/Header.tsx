...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      {/* Main header — white with logo + social icons */}
          ...
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="tg-icon-btn relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-[#229ED9] rounded-full transition-all duration-300 cursor-pointer"
                title="Telegram"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="max-icon-btn relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-[#168DE2] rounded-full transition-all duration-300 cursor-pointer"
                title="MAX"
              >
                <span className="text-white font-extrabold text-base sm:text-lg lg:text-xl tracking-tight">M</span>
              </a>

              {/* Contacts button — desktop only */}
              <Link
                href="/contacts"
                className="hidden lg:inline-flex px-4 py-2 border border-gray-300 hover:border-[#0e2a4e] text-gray-700 hover:text-[#0e2a4e] text-sm font-medium rounded-lg transition-colors"
              >
                Контакты
              </Link>
          ...
          <nav className="px-4 py-3 space-y-1">
            ...
            <div className="flex gap-3 px-4 pt-3 pb-1">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="tg-icon-btn flex items-center justify-center w-12 h-12 bg-[#229ED9] rounded-full"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="max-icon-btn flex items-center justify-center w-12 h-12 bg-[#168DE2] rounded-full"
              >
